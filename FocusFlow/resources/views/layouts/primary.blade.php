...
<link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:ital,wght@0,300;0,400;0,500;0,600;1,600&display=swap" rel="stylesheet">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="text-green ps-4 ms-2 text-uppercase text-xs font-weight-bolder ">{{__('Five Minute Journal')}} </h6>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item mt-3">
                <h6 class="text-green ps-4 ms-2 text-uppercase text-xs font-weight-bolder ">{{__('GOALS and Dreams')}}</h6>
            </li>
            ...
            <li class="nav-item mt-3">
                <h6 class="text-green ps-4 ms-2 text-uppercase text-xs font-weight-bolder ">{{__('Business Plan')}} </h6>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item mt-3">
                <h6 class="text-green ps-4 ms-2 text-uppercase text-xs font-weight-bolder ">{{__('Personal Projects')}} </h6>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item mt-3">
                <h6 class="text-green ps-4 ms-2 text-uppercase text-xs font-weight-bolder ">{{__('Actions')}}</h6>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item mt-3">
                <h6 class="text-green ps-4 ms-2 text-uppercase text-xs font-weight-bolder ">{{__('Knowledgebase')}}</h6>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item mt-3">
                <h6 class="text-green ps-4 ms-2 text-uppercase text-xs font-weight-bolder 6">{{__('Account pages')}} </h6>
            </li>
            ...
            <li class="nav-item mt-3">
                <h6 class="text-green ps-4 ms-2 text-uppercase text-xs font-weight-bolder ">{{__('Settings')}}  </h6>
            </li>
