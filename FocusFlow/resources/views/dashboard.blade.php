                    ...
                    @foreach($recent_projects as $project)
                        <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                                <span class="badge bg-gradient-success font-weight-bold">@if(!empty($project->start_date))
                                        {{$project->start_date->format(config('app.date_format'))}}
                                    @endif</span>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <span class="badge bg-gradient-primary font-weight-bold">@if(!empty($project->end_date))
                                ...
                                <div class="d-flex mt-4">
                                    ...
                                    <div class="ms-3">
                                        <div class="numbers">
                                            ...
                                            <span class="text-sm">{{$event->start_date->format(config('app.date_time_format'))}}---
                                                <span class="text-sm">{{$event->end_date->format(config('app.date_time_format'))}}</span></span>
