...
@section('content')
    <div class="card bg-gray-800">
        <div class="card-header bg-gray-800 text-white">
           <h6 class="text-white">{{__('5 Minute Daily Journal/ Meditation')}}</h6>
            <p class="form-text text-white text-xs opacity-7 ">
        ...
        <div class="card-body">
            <form action="/save-journal" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control bg-gray-800 text-white opacity-7"  name="date" type="date" value="{{date('Y-m-d')}}" id="date"
                           @if(!empty($journal))
                           value="{{$journal->date}}"
                           @else
                           value="{date('Y/m/d')}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="grateful" class="form-control bg-gray-800" id="grateful" rows="10">@if (!empty($journal)){{$journal->grateful}}@endif</textarea>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        tinymce.init({
            ...
            toolbar: 'numlist bullist| code |formatselect| bold italic',
