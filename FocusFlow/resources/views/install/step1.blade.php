...
@section('content')
    ...
    <ul class="list-group mt-3">
        ...
        <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">{{__('RouteServiceProvider.php:')}}</strong>
    ...
    <a class="btn btn-primary mt-3" href="{{route('step2')}}">{{__('Continue')}}</a>
